...
final class NerSpans {
   ...
   */
  static String[] tokenTexts(AnnotatedSentence sentence) {
   ...
   */
  static AnnotationSpan tokenSpanToDocumentSpan(AnnotatedSentence sentence, Span tokenSpan) {
   ...
   */
  static String resolveEntityType(String configuredType, Span span) {
